    ...
    <>
      ...
      <section className="waitlist" id="waitlist">
        <div className="waitlist-wrapper">
          ...
          <a href="https://wa.me/14155238886?text=join%20slight-wonder" target="_blank" rel="noopener noreferrer" className="whatsapp-btn">
      ...
      <footer className="footer">
        <div className="footer-inner">
          ...
          <a href="https://nex-chi-six.vercel.app/" target="_blank" rel="noopener noreferrer">Built by Jackson_Mwaniki_Munene</a>
          </div>
        </div>
      </footer>
    </>
